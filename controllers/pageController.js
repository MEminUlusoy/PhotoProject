...
//! 5)
//! Bu fonksiyonları routes içinden çağrılcak ve çağrılma durumuna göre bunlar sayfaları getircek. ulaşılabilmeleri için bu fonksiyonlara export ettik
...
const sendMail = async (req,res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            to: "ulusoyeminn@gmail.com",              // list of receivers
